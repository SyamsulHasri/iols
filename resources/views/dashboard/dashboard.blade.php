...
<head>
	...
	<link rel="shortcut icon" href="{{asset('dashboard/static/img/icons/icon-48x48.png')}}" />
		...
		<div class="main">
          ...
          <i class="hamburger align-self-center"></i>
              ...
              <i class="align-middle" data-feather="search"></i>
                ...
                <img src="{{asset('dashboard/static/img/avatars/avatar.jpg')}}" class="avatar img-fluid rounded mr-1" alt="Charles Hall" /> <span class="text-dark">Charles Hall</span>
              </a>
