...
<html lang="en">
    ...
    <head>
        ...
        <link rel="stylesheet" href="{{asset('multi/bootstrap/css/bootstrap.min.css')}}">
        <link rel="stylesheet" href="{{asset('multi/font-awesome/css/font-awesome.min.css')}}">
		<link rel="stylesheet" href="{{asset('multi/css/form-elements.css')}}">
    ...
    <body class="bg-secondary">
        ...
        <!-- Javascript -->
        <script src="{{asset('multi/js/jquery-1.11.1.min.js')}}"></script>
        <script src="{{asset('multi/bootstrap/js/bootstrap.min.js')}}"></script>
        <script src="{{asset('multi/js/jquery.backstretch.min.js')}}"></script>
        <script src="{{asset('multi/js/retina-1.1.0.min.js')}}"></script>
        <script src="{{asset('multi/js/scripts.js')}}"></script>
